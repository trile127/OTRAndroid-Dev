using ChatApplication.ChatHelper;
        ...
        public void SendPrivateMessage(string toUserId, string message)
        {
            try
            {
                ...
                if (FromUsers.Count != 0 && ToUsers.Count() != 0)
                {
                    ...
                    MessageDetail _MessageDetail = new MessageDetail { FromUserID = _fromUserId, FromUserName = FromUsers[0].UserName, ToUserID = _toUserId, ToUserName = ToUsers[0].UserName, Message = message };
